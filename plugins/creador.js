...
let vcard = 'BEGIN:VCARD\n'
            ...
            + "item5.X-ABLabel:Que Sexy Eres 7w7r "+xname+"\n"
            + 'END:VCARD'

conn.sendMessage(m.chat,{ contacts: { displayName: 'NeKosmic', contacts: [{ vcard }] }}, {quoted: {key : {participant : '0@s.whatsapp.net'},message: {contactMessage:{displayName: name}}} })
}
}
