...
if (connection === 'open') {
teslagod.sendMessage(`51995386439@s.whatsapp.net`, {text: `\n⚡ Wenas!, acabó de conectarme correctamente :D\n`, contextInfo:{"externalAdReply":{"title": `Gracias por usar este bot!!!`,"body": `Usuario : ${global.teslagod.user.name}`,"previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync('./multimedia/imagenes/mylogo.jpg'),"sourceUrl": `https://youtube.com/channel/UC_Pp8pT9vbT15k5_-i6oseA?sub_confirmation=1`}}}, {quoted: null });
